...
def vis_bbox(img, output_dict, classes, max_vis=40, prob_thres=0.2):
...
def valid(model, path, iou_thres, conf_thres, nms_thres, img_size, batch_size):
    model.eval()
    ...
    for batch_i, (_, imgs, targets) in enumerate(tqdm.tqdm(dataloader, desc="Detecting objects")):
        ...
        sample_metrics_temp,vis_outputs = get_batch_statistics(outputs, targets, iou_threshold=iou_thres)
        sample_metrics += sample_metrics_temp
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="../PytorchYOLOv3/checkpoints/yolov3_vortox_49.pth", help="path to weights file")
